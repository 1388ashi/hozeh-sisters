    ...
    <section>
        <div class="cover-image sptb ml-5 mr-5">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        @include('admin.pages.articles.filter')
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card mb-0 table-bordered">
                                    <div class="card-header border-0">
                                        <h4 class="card-title">آموزش ها</h4>
                                        
                                        <div class="card-options">
                                            <a href="{{route('articles.create')}}" class="btn btn-primary mr-30" data-target="#addarticles">ثبت آموزش جدید</a>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-vcenter text-nowrap table-hover border table-striped" id="support-categorylist">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td class="text-center"><span>{{$article->user->name}}</span></td>
                                                            <td class="text-center "><span>{{$article->category->name}}</span></td>
                                                            <td class="text-center "><span>{{$article->title}}</span></td>
                                                            <td class="text-center "><span>{{Str::limit($article->summary,60, '...')}}</span></td>
                                                            <td class="text-center">@include('includes.status',["status" => $article->status])</td>
                                                            <td class="text-center "><span>{{$article->views_count}}</span></td>
                                                            <td><img src="{{Storage::url($article->image)}}" style="width: 90px"></td>
                                                        
                                                            <td class="text-center">
                                                                <div class="d-flex justify-content-center">
                                                                    <a href="{{route('articles.show',[$article->id])}}" class="action-btns1">
                                                                        <i class="feather feather-eye text-primary" data-toggle="tooltip" data-placement="top" title="نمایش"></i>
                                                                    </a>
                                                                    <a href="{{route('articles.edit',[$article->id])}}" class="action-btns1"  data-target="#viewarticles">
                                                                        <i class="feather feather-edit text-warning" data-toggle="tooltip" data-placement="top" title="ویرایش"></i>
                                                                    </a>
                                                                    
                                                                        <button  class="action-btns1 item-delete"  data-toggle="modal" data-target="#deleteModal" data-title="{{$article->title}}" data-id="{{$article->id}}">
